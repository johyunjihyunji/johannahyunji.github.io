"use strict";(self.webpackChunkgatsby_starter_hello_world=self.webpackChunkgatsby_starter_hello_world||[]).push([[309,398],{4101:function(e,t,r){r.r(t);var n=r(6540),o=r(7581),s=r(3501);const i=o.Ay.footer`
  color: #FF1700;
  padding: 20px 0;
  text-align: center;
  width: 100%;
...
`,c=o.Ay.p`
  ...
  font-size: 16px;
  color: #FF1700;
`;t.default=()=>{const e=(new Date).getFullYear();return n.createElement(i,null,n.createElement(s.default,null),n.createElement(c,{style:{fontFamily:"'Inter', sans-serif"}},"© ",e," Johanna Lee"))}},3501:function(e,t,r){r.r(t);var n=r(6540),o=r(7581),s=r(5884);const i=o.Ay.div`
  display: flex;
  padding: 20px;
...
//# sourceMappingURL=component---src-pages-components-footer-js-9373025f69e2162b1756.js.map