        ...
        <div className="section">
          ...
          <div className="flex-container">
            <div className="subsection">
              <h3 className="subsection-title" style={{ color: '#5a5a5a' }}>Energy Science Network</h3>
            ...
            <div className="subsection">
              <h3 className="subsection-title" style={{ color: '#5a5a5a' }}>Lawrence Berkeley National Laboratory</h3>
              <p className="paragraph">
        ...
        <div className="section">
          ...
          <div className="flex-container">
            ...
            <div className="subsection" style={{ flex: '1', maxWidth: '60%' }}>
              <h3 className="subsection-title" style={{ color: '#48C5DC' }}>Modern Research Data Portal</h3>
              <p className="paragraph">
        ...
        <div className="section">
          ...
          <div className="flex-container">
            ...
            <div className="subsection" style ={{ maxWidth: '60%' }}>
              <h3 className="subsection-title" style={{ color: '#5a5a5a' }}>User Flow Redesign:</h3>
              <p className="paragraph">
              ...
              <h3 className="subsection-title" style={{ color: '#5a5a5a' }}>Distributable and Customizable Codebase Development:</h3>
              <p className="paragraph">
            ...
            <div className="team-photo" style={{ flex: '1', maxWidth: '40%' }}>
              ...
              />
              <a href="https://www.linkedin.com/posts/energysciencesnetwork_stem-summerstudents-interns-activity-7228803311460569089-k_iF?utm_source=share&utm_medium=member_desktop"
              style={{ textAlign: 'center', color: '#161616', textDecoration: 'none', display: 'block', fontSize:'14px' }}>
