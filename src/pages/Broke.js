      ...
      <div className="container">
        ...
        <div className="section">
          ...
          <div className="team-photo">
            ...
            <div className="subsection">
            <p className="paragraph">
              First day of the conference, I teamed up with 4 other passionate travellers to identify and solve problems under "travel accessbility."
              </p>
              
              <h3 className="subsection-title" style={{ color: '#6B0C76' }}>Problem Space</h3>
              <p className="paragraph">
              Through <b>17 interviews and 200+ survey results,</b> we identified the following painpoints: financial constraints, lack of budgeting knowledge, uncertainty in planing,
                limited access to travel resources.
                </p>

                <h3 className="subsection-title" style={{ color: '#6B0C76', background: '#ffffff', borderRadius: '30px', padding: '20px', textAlign: 'center'}}>
              ...
              <p className="paragraph" >
                <b style={{fontFamily: 'AlexRoss', fontSize: '2vw', background: 'rgba(107, 12, 118, 0.2)'}}>Travel Budgeting</b>
                <br/> 
                Users struggle to create budgets that align with their specific financial situation and travel goals, leading to overspending or under-saving.<br />
                <b style={{fontFamily: 'AlexRoss', fontSize: '2vw', background: 'rgba(107, 12, 118, 0.2)'}}>Lack of Motivation</b>
                <br/> 
                Users often lose track of their spending and saving in real-time, making it difficult to stay motivated and stay on top of their financial goals.<br />
                <b style={{fontFamily: 'AlexRoss', fontSize: '2vw', background: 'rgba(107, 12, 118, 0.2)'}}>Burden of Currency Exchange</b> 
                <br/>
                Users face financial burden and security concerns when making transactions while traveling due to difference in currency.  <br />
              </p>
              <h3 className="subsection-title" style={{ color: '#6B0C76' }}>Broke</h3>
              <p className="paragraph">
              Broke is a <b style={{background: 'none'}}>travel budgeting mobile app that allows users to track expenses in real-time, manage transactions, and plan itineraries.</b>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section" style = {{marginBottom: '10px'}}>
          ...
          <path fill-rule="evenodd" clip-rule="evenodd" d="M75.0001 37.5C78.4518 37.5 81.2501 40.2982 81.2501 43.75V106.25C81.2501 109.702 78.4518 112.5 75.0001 112.5C71.5483 112.5 68.7501 109.702 68.7501 106.25V43.75C68.7501 40.2982 71.5483 37.5 75.0001 37.5Z" fill="black"/>
            ...
            <p style={{marginLeft: "10px", fontFamily: 'AlexRoss', fontSize: '2vw'}}>
...
`          <iframe 
          ...
          ></iframe>`
          <p className='paragraph'>
         --> This prototype was presented to potential investors and program instructors/mentors at the final day of EIA program. 
