      ...
      <div className="container">
        ...
        <div className="info-row">
          ...
          <div className="info-item">
            ...
            <p className="info-content">
            <div className='tag'>End-to-End Design</div>
              ...
              <div className='tag'>User Interviews</div>
              <div className='tag'>User Survey</div>
            </p>
          </div>
        ...
        <div className="section">
          ...
          <div className="flex-container">
            ...
            <div className="subsection">
              <h3 className="subsection-title" style={{ color: '#6B0C76' }}>Sutardja Center Entrepreneurship & Technology (SCET)</h3>
              <p className="paragraph">
             SCET at UC Berkeley offers a <b>Certificate in Entrepreneurship and 
              Technology</b> designed to equip students with essential skills for innovation and leadership through a study abroad program to Segovia, Spain and Porto, Portugal.
                                    ...
                                    >
            <div className="subsection">
              <h3 className="subsection-title" style={{ color: '#6B0C76' }}>European Innovation Academy (EIA) </h3>
              <p className="paragraph">
              A a three-week startup program in Porto, Portugal, where students from diverse 
              backgrounds collaborate in <b>multidisciplinary teams to develop innovative product ideas.</b> 
                                    ...
                                    <motion.div
                                      ...
                                      transition={{ duration: 0.3 }} // Animation duration
                                    >
            <p className="paragraph"><b style={{fontStyle: 'italic', color: '#6B0C76', fontWeight: '400'}}>The last three weeks of my study abroad program, I participated in EIA.</b></p>
          </motion.div>
        ...
        <div className="section">
          ...
          <div className="subsection">
          <h3 className="subsection-title" style={{ color: '#6B0C76' }}>Introduction</h3>

            <p className="paragraph">
                First day of EIA, I teamed up with 4 other passionate travellers to identify and solve problems under <b style={{fontSize: '1.4', color: '#000065'}}>"travel accessibility"</b>.
                </p>
            ...
            <div className="subsection">
              ...
              Through 200+ survey results and 17 interviews, we identified the following pain points of travel accessibility for young adults: 
              <b> financial constraints, lack of budgeting knowledge, limited access to travel resources. </b> 
              </p>
              <p className="paragraph">
            ...
            <h3 className="boxsection-title" style={{ color: '#000065'}} > User Insights</h3>

              <ul className="paragraph" style={{display: 'flex', textAlign: 'left', flexDirection: 'column', gap: '30px'}} >
                <li>
                <b style={{margin: '5px', padding: '5px', borderRadius: '30px',  background: 'rgba(107, 12, 118, 0.2)'}}>Travel Budgeting: </b>
                <br/>
                Users struggle to create budgets that align with their specific financial situation and travel goals.
                </li>
                <li>
                <b style={{margin: '5px', padding: '5px', borderRadius: '30px', background: 'rgba(107, 12, 118, 0.2)'}}>Lack of Motivation:</b>
                <br/>
                Users often lose track of their spending and saving in real-time, discouraging them from traveling
                </li>
                <li>
                <b style={{margin: '5px', padding: '5px', borderRadius: '30px',  background: 'rgba(107, 12, 118, 0.2)'}}>Burden of Currency Exchange:</b>
                <br/>
                Users face financial burden and security concerns when making transactions abroad. 
                </li>
              </ul>
              </div>
              </motion.div>
        ...
        <div className="section" style = {{marginBottom: '10px'}}>
          ...
          <div className="subsection">
            <h2 className="subsection-title" style={{ color: '#6B0C76' }}>Brand Design System</h2>
            <p className='paragraph' >
          ...
          <div className="subsection">
            <h3 className="subsection-title" style={{ color: '#6B0C76' }}>Userflow</h3>
            <p className="paragraph">
       ...
       {/* should add proper lwofi */}


          <div className="boxsection" style={{ textAlign: 'left' }} >
          <h3 className="boxsection-title" style={{ color: '#000065', textAlign: 'center'}} > Pain points to Solutions</h3>
            ...
            <path fill-rule="evenodd" clip-rule="evenodd" d="M75.0001 37.5C78.4518 37.5 81.2501 40.2982 81.2501 43.75V106.25C81.2501 109.702 78.4518 112.5 75.0001 112.5C71.5483 112.5 68.7501 109.702 68.7501 106.25V43.75C68.7501 40.2982 71.5483 37.5 75.0001 37.5Z" fill="black"/>
              ...
              <p style={{margin: '0', fontSize: '1rem', color: 'black', fontWeight: '500'}}>
          ...
          <p className='paragraph'>
         This prototype was <b>presented to potential investors</b>  and program instructors/mentors at the final day of EIA program.
          </p>
          </div>
          </motion.div>
                                    <motion.div
