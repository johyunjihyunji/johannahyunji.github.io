        ...
        <div className="section">
          ...
          <div className="flex-container">
            <div className="subsection">
              ...
              <b>Energy Sciences Network</b> is a high-performance network designed to support large-scale scientific research by <b>interconnecting the U.S. 
              Department of Energy's national laboratory system</b>. 
              </p>
              <p className="paragraph">
              It facilitates the <b>transfer of massive data sets</b> generated by scientific experiments, enabling 
              collaboration among researchers across various disciplines.
              </p>
            </div>
            <div className="subsection">
              <h3 className="subsection-title" style={{ color: '#50C5DB' }}>Lawrence Berkeley National Laboratory</h3>
              <p className="paragraph">
              <b>Lawrence Berkeley National Laboratory</b> is a leading research facility located in Berkeley, California, and operated by the 
              University of California. 
              </p>
              <p className="paragraph">
              Funded by the <b>U.S. Department of Energy</b>, LBNL focuses on advancing scientific knowledge in areas such as <b>energy efficiency,
        ...
        <div className="section">
          ...
          <div className="flex-container">
            ...
            <div className="subsection">
              ...
              <p className="paragraph">
                <b>MRDP streamlines high-speed data transfer process by:</b>
              </p>
              <p className="paragraph">
              <ul className="bullet-list">
                <li>Enables fast and reliable file transfers between authorized Globus points.</li>
                <li>Provides a single portal for initiating transfers, browsing datasets, and monitoring progress.</li>
                <li>Accelerates research workflows, facilitating efficient data movement and collaboration among researchers.</li>
              </ul>
              </p>

              <h3 className="subsection-title" style={{ color: '#50C5DB' }}>Goal</h3>
              <p className="paragraph">
