     ...
     <Header />
      <div className="container">
        ...
        <div className="section">
          ...
          <div className="subsection">
            ...
            <div className="subsection">
              ...
              <svg style={{flexShrink: 0, width: '40px', height: '40px', marginRight: '10px'}} viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="section">
          ...
          <div style={{display: "flex", alignItems: "center"}}>
            <p className="paragraph" style={{marginRight: "20px"}}>
            MRDP Cookie-Cutter Deployment with Details
            </p>
            <a 
