...
const LopsterGallery=()=>{const{0:rotations,1:setRotations}=(0,index_js_.useState)([]);const images=(0,index_js_.useMemo)(()=>[{id:1,src:lopster/* default */.A,speed:10,direction:1},{id:2,src:lopster/* default */.A,speed:9,direction:-1},{id:3,src:lopster/* default */.A,speed:14,direction:1},{id:4,src:lopster/* default */.A,speed:8,direction:-1},{id:5,src:lopster/* default */.A,speed:13,direction:1},{id:6,src:lopster/* default */.A,speed:10,direction:-1},{id:7,src:lopster/* default */.A,speed:8,direction:1},{id:8,src:lopster/* default */.A,speed:9,direction:-1},{id:9,src:lopster/* default */.A,speed:7,direction:1},{id:10,src:lopster/* default */.A,speed:5,direction:-1},{id:9,src:lopster/* default */.A,speed:7,direction:1},{id:10,src:lopster/* default */.A,speed:5,direction:-1}],[]);(0,index_js_.useEffect)(()=>{const initialRotations=Array(images.length).fill(0);setRotations(initialRotations);const interval=setInterval(()=>{setRotations(prevRotations=>prevRotations.map((rotation,index)=>{const{speed,direction}=images[index];return(rotation+speed*direction+360)%360;// Ensure positive rotation
