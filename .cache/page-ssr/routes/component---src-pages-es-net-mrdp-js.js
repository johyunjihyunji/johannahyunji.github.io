...
,viewport:{once:true}// Only animate once
,transition:{duration:0.3}// Animation duration
},/*#__PURE__*/index_js_default().createElement("div",{className:"subsection"},/*#__PURE__*/index_js_default().createElement("div",{className:"team-photo"},/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* StaticImage */.iS,{src:"../../static/ESNetMRDPPresentation.jpg",alt:"Project Header",placeholder:"blurred",layout:"constrained",style:{marginTop:'40px',borderRadius:'10px'},__imageData:__webpack_require__(4936)}),/*#__PURE__*/index_js_default().createElement("p",{className:"photoDescription"},"Student Poster Session for Berkeley Lab Computing Sciences",/*#__PURE__*/index_js_default().createElement("br",null),"Presenting to ESNet Executive Director Inder Monga")))),/*#__PURE__*/index_js_default().createElement(proxy/* motion */.P.div,{initial:{opacity:0,scale:0.9,y:20}// Initial state
,whileInView:{opacity:1,scale:1,y:0}// Animate state when in view
,viewport:{once:true}// Only animate once
,transition:{duration:0.3}// Animation duration
