...
const pageVariants={initial:{opacity:0,y:"100%"},animate:{opacity:1,y:0},exit:{opacity:0,y:"-100%"}};const pageTransition={duration:0.8};const ArtGallery=()=>{const{0:flippedStates,1:setFlippedStates}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([false,false,false,false,false,false,false,false,false,false]);const{0:aspectRatios,1:setAspectRatios}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);const artworks=[{src:"../../1x/Artboard 1_2.png",title:"UC JAZZ FALL CONCERT ALIEN INVASION",description:"Designed a poster for the UC Berkeley Jazz Fall Concert, featuring the Advanced Combos, with an alien invasion theme."},{src:"../../1x/Artboard 1.png",title:"PLEASE BE YOURSELF",description:"Transformed a candid digital photo of a friend enjoying coffee into a graphic poster."},{src:"../../1x/JOPOSTER.jpg",title:"LET'PLAY2",description:"Inspired by a Taco Tuesday outing, this poster blends color pencils with digital refinement in Photoshop."},{src:"../../1x/catalina.jpg",title:"SHOCKED IN CATALINA",description:"Captured Catalina Island on film during my scuba diving trip and added hand-drawn illustrations."},{src:"../../1x/IMG_1079.JPG",title:"TO LIVE IN SF",description:"Captured a moment in San Francisco on film and added hand-drawn illustrations."},{src:"../../1x/jeju.jpg",title:"Travels",description:"A Jeju Island cafe on film with a hand-drawn illustration of a dog I met in Santa Monica, CA."},{src:"../../1x/love.jpg",title:"LOVE",description:"A Jeju Island garden on film with hand-drawn illustration of an owl."}];const handleFlip=index=>{setFlippedStates(prevStates=>{const newStates=[...prevStates];newStates[index]=!newStates[index];return newStates;});};const loadImage=src=>{return new Promise((resolve,reject)=>{const img=new Image();img.onload=()=>resolve(img.height/img.width);img.onerror=reject;img.src=src;});};(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const loadAllImages=async()=>{const ratios=await Promise.all(artworks.map(artwork=>loadImage(artwork.src)));setAspectRatios(ratios);};loadAllImages();},[]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("style",null,`
        ...
        `),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(framer_motion__WEBPACK_IMPORTED_MODULE_4__/* .motion */ .P.div,{variants:pageVariants,initial:"initial",animate:"animate",exit:"exit",transition:pageTransition,className:"art-gallery",style:{background:`
          ...
          `,backgroundSize:'400% 400%',animation:'meshAnimation 14s ease infinite',minHeight:'100vh',padding:'3rem',margin:'0px'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"grain"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{style:{color:"#fe5204",textAlign:'center',marginBottom:'2rem',fontFamily:'AlexRoss',fontSize:'5rem'}}," WElcome To the LObSTER pArk"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{display:'flex',flexDirection:'row',width:'100%',gap:'4vw',marginBottom:'5rem'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{display:'flex',flexDirection:'column',alignContent:'center',justifyContent:'center'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_3__.Link,{to:"/"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",{className:"Logo",src:_static_lopster_png__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A,alt:"Logo",style:{margin:'0',padding:'0'}})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{style:{fontSize:'1rem',fontFamily:'cousine',textAlign:'center',margin:'0',padding:'0',color:'#ffff'}},"HOME")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{fontFamily:'cousine',fontSize:'1rem'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{style:{fontSize:'1.2rem'}},"\uD83D\uDEDD Playground Rules: "),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ol",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b",{style:{fontFamily:"cousine-bold"}},"Dream Wildly:")," No limits here!"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b",{style:{fontFamily:"cousine-bold"}},"Experiment:")," design, learn, and iterate!"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b",{style:{fontFamily:"cousine-bold"}},"Respect the Space:")," Keep it tidy, keep it beautiful, keep it creative.")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{style:{fontSize:'1rem',fontFamily:'cousine-italic'}},"* This play area is designed for children 5+"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{style:{fontSize:'1rem',fontFamily:'cousine-italic'}},"* Click art to learn more"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{display:'flex',flexWrap:'wrap',justifyContent:'space-between'}},artworks.map((artwork,index)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(framer_motion__WEBPACK_IMPORTED_MODULE_4__/* .motion */ .P.div,{key:index,style:{width:'calc(33% - 1rem)',marginBottom:'2rem',aspectRatio:aspectRatios[index]?`1 / ${aspectRatios[index]}`:'auto'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(framer_motion__WEBPACK_IMPORTED_MODULE_4__/* .motion */ .P.div,{style:{width:'100%',height:'100%',transformStyle:'preserve-3d',cursor:'pointer'},animate:{rotateY:flippedStates[index]?180:0},transition:{duration:0.8},onClick:()=>handleFlip(index)},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"front",style:{position:'absolute',width:'100%',backfaceVisibility:'hidden',display:'flex',justifyContent:'center',alignItems:'center',backgroundColor:'#2a2a2a',borderRadius:'0px',boxShadow:'0 0 20px rgba(255,255,255,0.2)',overflow:'hidden'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",{src:artwork.src,alt:artwork.title,style:{width:'100%',height:'100%',objectFit:'contain'}})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"back",style:{position:'absolute',backfaceVisibility:'hidden',transform:'rotateY(180deg)',display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',backgroundColor:'#2a2a2a',borderRadius:'0px',// Adjusted to match the front side
padding:'1rem',color:'#fff'}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{style:{maxWidth:'80%',textAlign:'center'}},artwork.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{style:{maxWidth:'80%',textAlign:'center'}},artwork.description))))))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArtGallery);
